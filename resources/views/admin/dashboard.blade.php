...
@section('sidebar')
    @include("layouts/partials/admin.admin_sidebar")
@endsection

@section('header')
    @include("layouts/partials/admin.admin_header")
@endsection
    ...
    <div class="card mb-3 overflow-hidden" style="min-width: 12rem">
        ...
        <div class="card-body position-relative">
            ...
            <div class="display-4 fs-4 mb-2 font-weight-normal text-sans-serif"
                data-countup='{"count":43594,"format":"comma","prefix":"$"}'>{{$story_count}}</div><a
...
@section('footer')
    @include("layouts/partials/admin.admin_footer")
@endsection