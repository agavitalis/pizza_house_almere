    ...
    <body>
        <div class="wrapper">
           ...
           <![endif]-->  
            ...
            <header>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col col-md-2 col-sm-8 col-xs-8" style="display:flex">
                            <!-- Logo Start  -->
                            <div id="logo">
                                <a href="index.html">
                        ...
                        <div class="col-md-3 col-sm-12 col-xs-12 button-top paddleft">
            ...
            <!-- Banner Start -->
            <div class="banner-bg"> 
                <div class="video-bg" data-property="{videoURL:'https://youtu.be/95SNbn340TE',containment:'.banner-bg',autoPlay:true, mute:true, startAt:0, opacity:1}"> </div>
                <!-- Banner Detail Start  -->
                                    ...
                                    <div class="box">
                                        ...
                                        <div class="form-group col-xs-12 col-md-12">
                                            <div class="text-center">
                                                <button  class="btn btn-theme btn-sm">+<i class="icofont icofont-cart-alt"></i></i>Add to Cart</button>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Box End -->
                                                    ...
                                                    <div class="caption">
                                                       ...
                                                       <div class="price">
                                                            ...
                                                            <div class="text-center mt-3">
                                                                <button type="submit" class="btn btn-theme btn-sm">+<i class="icofont icofont-cart-alt"> <span class="d-sm-block d-md-none text-white">Add to Cart</span></i></button>
                                                            </div>
                                                       </div>
